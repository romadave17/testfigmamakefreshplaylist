import svgPaths from "./svg-ourh9txys1";
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] h-[110.086px] justify-end leading-[0] not-italic relative shrink-0 text-[90.98px] text-black tracking-[0.9098px] w-full">
...
function MmddyyXxProjectNameTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] overflow-clip rounded-[20px] size-[727.839px] top-[calc(50%-528.53px)]" data-name="MMDDYY_XX_ProjectName_TA_PA_Tile_2400x2400">
      <Images />
      <AmLogotype />
      <Background3 />
      <PlaylistTitle />
