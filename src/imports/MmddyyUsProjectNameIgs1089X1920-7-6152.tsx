import svgPaths from "./svg-dss6wc3yp3";
...
function ArtistImage() {
  return (
    <div className="absolute left-[347.98px] size-[1080px] top-[221.98px]" data-name="Artist Image_01">
      <Guides />
...
function ArtistImageHere() {
  return (
    <div className="absolute left-[calc(50%-7.49px)] size-[1762.98px] top-[-221.86px] translate-x-[-50%]" data-name="Artist Image Here">
      <ArtistImage />
    </div>
  );
}
...
function EventNameHeadline() {
  return (
    <div className="content-stretch flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] gap-[35px] items-start justify-center relative shrink-0 w-full" data-name="Event Name-Headline">
      ...
      <p className="leading-[0.9] relative shrink-0 text-[110px] tracking-[1.1px] w-[1096px]">Fresh Jazz</p>
    </div>
  );
}
