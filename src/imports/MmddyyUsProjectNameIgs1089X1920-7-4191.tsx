import svgPaths from "./svg-zkh80457gw";
...
function ArtistImage() {
  return (
    <div className="absolute left-[354.98px] size-[1080px] top-[223.98px]" data-name="Artist Image_01">
      <Guides />
...
function EventNameHeadline() {
  return (
    <div className="content-stretch flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] gap-[35px] items-start justify-center relative shrink-0 w-full" data-name="Event Name-Headline">
      ...
      <p className="leading-[0.9] relative shrink-0 text-[110px] tracking-[1.1px] w-[1096px]">Fresh Dance</p>
    </div>
  );
}
