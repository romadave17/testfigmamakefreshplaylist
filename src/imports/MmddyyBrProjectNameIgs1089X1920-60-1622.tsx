import svgPaths from "./svg-1tt7mklt7t";
...
function Guides() {
  return (
    <div className="absolute contents inset-[-30.96%_-52.64%_-50.64%_-54.64%]" data-name="Guides">
      <div className="absolute bg-[#d8d8d8] border-[#f4f4f4] border-[4.29px] border-dashed inset-[-30.96%_-52.64%_-50.64%_-54.64%] opacity-40" data-name="Background_Image" />
      <div className="absolute font-['Amazon_Ember_Display:Regular',sans-serif] inset-[71.52%_0.57%_15.48%_-0.57%] leading-[1.1] not-italic opacity-50 text-[#f4f4f4] text-[78.384px] text-center tracking-[0.7838px]">
      ...
      <div className="absolute inset-[4.14%_11.27%_17.19%_9.84%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 850 848">
          <path d={svgPaths.p4aa8000} fill="var(--fill-0, #F4F4F4)" id="Vector" opacity="0.5" />
        </svg>
      </div>
    </div>
  );
...
function ArtistImage() {
  return (
    <div className="absolute left-[331.82px] size-[1076.88px] top-[178.2px]" data-name="Artist Image_01">
      <Guides />
      <div className="absolute aspect-[1083/1083] left-[-0.67%] right-[-0.61%] top-[-6.62px]" data-name="Sample_image">
...
function ArtistImageHere() {
  return (
    <div className="absolute left-[calc(50%-1.49px)] size-[1738.98px] top-[-176.86px] translate-x-[-50%]" data-name="Artist Image Here">
      <ArtistImage />
    </div>
  );
}
...
function EventNameHeadline() {
  return (
    <div className="content-stretch flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] gap-[35px] items-start justify-center relative shrink-0 w-full" data-name="Event Name-Headline">
      ...
      <div className="leading-[0.9] relative shrink-0 text-[110px] tracking-[1.1px] w-[1096px]">
        <p className="mb-0">Fresh</p>
        <p>{`Eletrônica Brasil `}</p>
      </div>
    </div>
  );
}
...
function Copy() {
  return (
    <div className="content-stretch flex flex-col gap-[36.67px] h-[393px] items-start justify-center not-italic relative shrink-0 text-black w-full" data-name="Copy">
      <EventNameHeadline />
      <p className="-webkit-box font-['Ember_Modern_Display_Standard:Regular',sans-serif] leading-none overflow-ellipsis overflow-hidden relative shrink-0 text-[65px] tracking-[0.65px] w-full">com Artist Name</p>
    </div>
  );
}
...
function PaddingLeftAligned() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[959px] items-start left-[calc(50%-0.3px)] pb-0 pl-[120px] pr-[60px] pt-[19px] top-[calc(50%+480.5px)] translate-x-[-50%] translate-y-[-50%] w-[1081px]" data-name="Padding - Left Aligned">
      <Layout />
    </div>
  );
}
...
export default function MmddyyBrProjectNameIgs1089X() {
  return (
    <div className="relative size-full" data-name="MMDDYY_BR_ProjectName_IGS_1089x1920">
