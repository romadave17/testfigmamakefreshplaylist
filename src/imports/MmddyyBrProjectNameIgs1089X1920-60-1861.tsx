import svgPaths from "./svg-atmvg5pqm2";
...
function EventNameHeadline() {
  return (
    <div className="content-stretch flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] gap-[35px] items-start justify-center relative shrink-0 w-full" data-name="Event Name-Headline">
      ...
      <p className="leading-[0.9] relative shrink-0 text-[110px] tracking-[1.1px] w-[1096px]">{`Fresh Rap & Trap `}</p>
    </div>
  );
}
...
function Copy() {
  return (
    <div className="content-stretch flex flex-col gap-[36.67px] h-[393px] items-start justify-center not-italic relative shrink-0 text-white w-full" data-name="Copy">
      <EventNameHeadline />
