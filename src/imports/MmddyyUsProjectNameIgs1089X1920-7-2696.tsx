import svgPaths from "./svg-kf1rs12fdp";
...
function Guides() {
  return (
    <div className="absolute contents inset-[-30.96%_-52.64%_-50.64%_-54.64%]" data-name="Guides">
      ...
      <div className="absolute font-['Ember_Modern_Display_Standard:Bold',sans-serif] inset-[71.52%_0.57%_15.24%_-0.57%] leading-[1.1] not-italic opacity-50 text-[#f4f4f4] text-[80.007px] text-center tracking-[0.8001px]">
...
function ArtistImage() {
  return (
    <div className="absolute left-[350.98px] size-[1080px] top-[222.98px]" data-name="Artist Image_01">
      <Guides />
...
function ArtistImageHere() {
  return (
    <div className="absolute left-[calc(50%-4.49px)] size-[1774.98px] top-[-224.86px] translate-x-[-50%]" data-name="Artist Image Here">
      <ArtistImage />
    </div>
  );
}
...
function EventNameHeadline() {
  return (
    <div className="content-stretch flex flex-col gap-[35px] items-start justify-center relative shrink-0 w-full" data-name="Event Name-Headline">
      ...
      <p className="leading-[0.9] relative shrink-0 text-[110px] tracking-[1.1px] w-[1096px]">Fresh Rock</p>
    </div>
  );
}
...
function Copy() {
  return (
    <div className="content-stretch flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] gap-[36.67px] h-[393px] items-start justify-center not-italic relative shrink-0 text-white w-full" data-name="Copy">
      <EventNameHeadline />
