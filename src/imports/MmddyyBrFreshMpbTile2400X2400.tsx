...
function MmddyyBrFreshMpbTile2400X({ className }: { className?: string }) {
  return (
    <div className={className} data-name="MMDDYY_BR_FreshMPB_TA_PA_Tile_2400x2400">
...
export default function MmddyyBrFreshMpbTile2400X1() {
  return <MmddyyBrFreshMpbTile2400X className="bg-[#565656] relative size-full" />;
}
