import svgPaths from "./svg-ldhjuhj2t6";
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] h-[110.086px] justify-end leading-[0] not-italic relative shrink-0 text-[136.47px] text-black tracking-[1.3647px] w-full" style={{ transform: 'translateY(10px)' }}>
        <p className="leading-[0.9]">{`R&B`}</p>
      </div>
    </div>
  );
}
...
function FreshWordMark() {
  return (
    <div className="absolute h-[122.519px] left-[-3.67px] top-[calc(100%-257.39px)] w-[237.457px]" data-name="Fresh_Word_mark">
      <FreshDevice />
      <div className="absolute flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] inset-0 items-center justify-center leading-[0] not-italic text-[66.423px] text-nowrap text-white tracking-[0.6642px]">
...
function MmddyyUsProjectNameTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] rounded-[20px] size-[727.839px] top-[calc(50%-528.52px)]" data-name="MMDDYY_US_ProjectName_TA_PA_Tile_2400x2400">
...
export default function MmddyyUsProjectNameSocialXLarge1080X() {
  return (
    <div className="relative size-full" data-name="MMDDYY_US_ProjectName_Social_XLarge_1080x1920">
      <Background1 />
      <AmazonMusicLogotype />
      <Container />
      ...
      <MmddyyUsProjectNameTaPaTile2400X />
    </div>
  );
}