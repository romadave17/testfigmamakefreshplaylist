import svgPaths from "./svg-hvaemp4fez";
import imgSampleImage from "figma:asset/123b17e7b2e0d7d419b627d35fbb50cd03085af0.png";

function Background() {
  return <div className="absolute bg-[#25d1da] inset-0" data-name="Background" />;
}
...
function Rd4MasterLogo() {
  return (
    <div className="absolute inset-[0.28%_0.18%_2.11%_0.06%]" data-name="RD4 Master Logo">
...
function AmazonMusicLogotype() {
  return (
    <div className="absolute h-[101.15px] left-[calc(50%-171.44px)] top-[calc(50%+601.36px)] w-[342.882px]" data-name="Amazon Music Logotype">
      <Vector />
      <AmazonMasterRd />
      <p className="absolute bottom-[72.88%] font-['Ember_Modern_Display_Standard:Regular',sans-serif] leading-[normal] left-[calc(50%-0.73px)] not-italic text-[30.241px] text-black text-center text-nowrap top-[-8.47%] translate-x-[-50%] whitespace-pre">Disponível só no</p>
    </div>
  );
}
...
function Guides() {
  return (
    <div className="absolute contents inset-[-30.96%_-52.64%_-50.64%_-54.64%]" data-name="Guides">
      <div className="absolute bg-[#d8d8d8] border-[#f4f4f4] border-[2.909px] border-dashed inset-[-30.96%_-52.64%_-50.64%_-54.64%] opacity-40" data-name="Background_Image" />
      <div className="absolute font-['Amazon_Ember_Display:Regular',sans-serif] inset-[71.52%_0.57%_15.47%_-0.57%] leading-[1.1] not-italic opacity-50 text-[#f4f4f4] text-[53.155px] text-center tracking-[0.5315px]">
      ...
      <div className="absolute inset-[4.14%_11.27%_17.19%_9.84%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 577 575">
          <path d={svgPaths.p7668a00} fill="var(--fill-0, #F4F4F4)" id="Vector" opacity="0.5" />
        </svg>
      </div>
    </div>
  );
...
function ArtistImage() {
  return (
    <div className="absolute left-[-1.32px] size-[730.265px] top-[-2.46px]" data-name="Artist Image_01">
      <Guides />
      <div className="absolute aspect-[1083/1083] left-[-0.67%] right-[-0.61%] top-[-4.49px]" data-name="Sample_image">
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] h-[110.086px] justify-end leading-[0] not-italic relative shrink-0 text-[136.47px] text-black tracking-[1.3647px] w-full">
        <p className="leading-[0.9]">Samba</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute h-[122.216px] left-[-0.09px] top-0 w-[237.457px]" data-name="Fresh Device">
      <div className="absolute bottom-0 left-[-0.08%] right-0 top-[-0.13%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 238 123">
          <g id="Fresh Device">
            <path d={svgPaths.p2a84c080} fill="var(--fill-0, black)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
...
function FreshWordMark() {
  return (
    <div className="absolute h-[122.519px] left-[-3.67px] top-[calc(100%-257.39px)] w-[237.457px]" data-name="Fresh_Word_mark">
      <FreshDevice />
      <div className="absolute flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] justify-end leading-[0] left-[calc(50%-78.98px)] not-italic text-[66.423px] text-nowrap text-white top-[80.62px] tracking-[0.6642px] translate-y-[-100%]">
...
function MmddyyXxProjectNameTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] overflow-clip rounded-[20px] size-[727.839px] top-[calc(50%-528.52px)]" data-name="MMDDYY_XX_ProjectName_TA_PA_Tile_2400x2400">
      <Images />
      <AmLogotype />
      <Background3 />
      <PlaylistTitle />
...
export default function MmddyyBrProjectNameSocialXLarge1080X() {
  return (
    <div className="relative size-full" data-name="MMDDYY_BR_ProjectName_Social_XLarge_1080x1920">
      <Background1 />
      <AmazonMusicLogotype />
      <Container />
      ...
      <MmddyyXxProjectNameTaPaTile2400X />
    </div>
  );
}