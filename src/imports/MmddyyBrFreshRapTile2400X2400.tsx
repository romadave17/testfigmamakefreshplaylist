...
function MmddyyBrFreshRapTile2400X({ className }: { className?: string }) {
  return (
    <div className={className} data-name="MMDDYY_BR_FreshRap_TA_PA_Tile_2400x2400">
...
export default function MmddyyBrFreshRapTile2400X1() {
  return <MmddyyBrFreshRapTile2400X className="bg-[#565656] relative size-full" />;
}
