import svgPaths from "./svg-yshorvffl0";
...
function MmddyyUsProjectNameTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] rounded-[20px] size-[727.839px] top-[calc(50%-528.53px)]" data-name="MMDDYY_US_ProjectName_TA_PA_Tile_2400x2400">
