import svgPaths from "./svg-uuqgl3pv0h";
...
function Background3() {
  return (
    <div className="absolute h-[164.673px] left-0 top-[calc(100%-164.59px)] w-[727.839px]" data-name="Background">
      <Background2 />
    </div>
  );
}
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[90.98px] text-black tracking-[0.9098px] w-full" style={{ transform: 'translateY(10px)' }}>
        <p className="leading-[0.9]">{`Folk & Americana`}</p>
      </div>
    </div>
  );
}
