import svgPaths from "./svg-68c3sw3uxz";
  ...
  return (
    <div className="absolute contents inset-[-30.96%_-52.64%_-50.64%_-54.64%]" data-name="Guides">
      ...
      <div className="absolute font-['Amazon_Ember_Display:Regular',sans-serif] inset-[71.52%_0.57%_15.43%_-0.57%] leading-[1.1] not-italic opacity-50 text-[#f4f4f4] text-[53.155px] text-center tracking-[0.5315px]">
        <p className="mb-0 whitespace-pre-wrap">{`Repla  ce me`}</p>
...
function Background3() {
  return (
    <div className="absolute h-[158.608px] left-0 top-[calc(100%-158.53px)] w-[727.839px]" data-name="Background">
      <Background2 />
    </div>
  );
}
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[90.98px] text-white tracking-[0.9098px] w-full" style={{ transform: 'translateY(10px)' }}>
        <p className="leading-[0.9]">{`Folk & Acoustic`}</p>
      </div>
    </div>
  );
}
