...
function MmddyyBrFreshRapTrapTile2400X({ className }: { className?: string }) {
  return (
    <div className={className} data-name="MMDDYY_BR_FreshRapTrap_TA_PA_Tile_2400x2400">
...
export default function MmddyyBrFreshRapTrapTile2400X1() {
  return <MmddyyBrFreshRapTrapTile2400X className="bg-[#565656] relative size-full" />;
}
