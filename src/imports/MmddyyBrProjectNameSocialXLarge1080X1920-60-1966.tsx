import svgPaths from "./svg-7bycgd37ze";
import imgSampleImage from "figma:asset/123b17e7b2e0d7d419b627d35fbb50cd03085af0.png";

function Background() {
  return <div className="absolute bg-[#5032ff] inset-0" data-name="Background" />;
}
...
function AmazonMusicLogotype() {
  return (
    <div className="absolute h-[101.15px] left-[calc(50%-171.44px)] top-[calc(50%+601.36px)] w-[342.882px]" data-name="Amazon Music Logotype">
      <Vector />
      <AmazonMasterRd />
      <p className="absolute bottom-[72.88%] font-['Ember_Modern_Display_Standard:Regular',sans-serif] leading-[normal] left-[calc(50%-0.73px)] not-italic text-[30.241px] text-center text-nowrap text-white top-[-8.47%] translate-x-[-50%] whitespace-pre">Disponível só no</p>
    </div>
  );
}
...
function PlaylistTitle() {
  return (
    <div className="absolute bottom-[-0.16px] box-border content-stretch flex flex-col items-center justify-end left-[calc(100%-363.84px)] p-[36.392px] size-[727.839px] translate-x-[-50%]" data-name="Playlist Title">
      <div className="flex flex-col font-['Ember_Modern_Display_Standard:Bold',sans-serif] h-[110.086px] justify-end leading-[0] not-italic relative shrink-0 text-[136.47px] text-white tracking-[1.3647px] w-full">
        <p className="leading-[0.9]">{` Rap & Trap `}</p>
      </div>
    </div>
  );
}
...
function MmddyyXxProjectNameTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] rounded-[20px] size-[727.839px] top-[calc(50%-528.53px)]" data-name="MMDDYY_XX_ProjectName_TA_PA_Tile_2400x2400">
