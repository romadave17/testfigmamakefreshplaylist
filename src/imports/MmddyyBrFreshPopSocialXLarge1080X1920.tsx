...
function MmddyyBrFreshPopTaPaTile2400X() {
  return (
    <div className="absolute bg-[#565656] left-[calc(50%-362.67px)] rounded-[20px] size-[727.839px] top-[calc(50%-528.53px)]" data-name="MMDDYY_BR_FreshPop_TA_PA_Tile_2400x2400">
...
export default function MmddyyBrFreshPopSocialXLarge1080X() {
  return (
    <div className="relative size-full" data-name="MMDDYY_BR_FreshPop_Social_XLarge_1080x1920">
      <Background1 />
      <AmazonMusicLogotype />
      <Container />
