import svgPaths from "./svg-cxxxgn4e5r";
...
function ArtistImage() {
  return (
    <div className="absolute left-[354.98px] size-[1080px] top-[239.98px]" data-name="Artist Image_01">
      <Guides />
      <div className="absolute aspect-[1083/1083] left-[0.04%] right-[-0.04%] top-[-0.48px]" data-name="Sample_image">
...
function ArtistImageHere() {
  return (
    <div className="absolute left-[calc(50%-14.49px)] size-[1762.98px] top-[-239.86px] translate-x-[-50%]" data-name="Artist Image Here">
      <ArtistImage />
    </div>
  );
}
...
function Layout() {
  return (
    <div className="content-stretch flex flex-col gap-[120px] items-start relative shrink-0 w-full" data-name="Layout">
      <Copy />
    </div>
  );
}
...
function PaddingLeftAligned() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[959px] items-start left-[calc(50%-0.3px)] pl-[120px] pr-[60px] py-0 top-[calc(50%+560.5px)] translate-x-[-50%] translate-y-[-50%] w-[1081px]" data-name="Padding - Left Aligned">
      <Layout />
    </div>
  );
}
...
export default function MmddyyBrFreshEletronicaBrasilIgs1089X() {
  return (
    <div className="relative size-full" data-name="MMDDYY_BR_FreshEletronicaBrasil_IGS_1089x1920">
